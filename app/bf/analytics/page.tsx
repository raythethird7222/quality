    ...
    <div className="min-h-screen bg-[#020d1b] text-[#F8F8F6]">
      <div className="mx-auto max-w-[1400px]">
        <section id="view-analytics-dashboard" className="p-6 md:p-10">
          <div className="mb-6">
            <Link href="/bf/dashboard" className="mb-4 inline-flex items-center gap-2 rounded-lg border border-[#243d5b] bg-[#071827] px-4 py-2 text-sm font-medium text-[#C8A54B] transition hover:border-[#C8A54B] hover:bg-[#0a2540]">
              <ArrowLeft size={18} />
              Return back
            </Link>
            <h2 id="txt-analytics-title" className="text-xl font-bold text-[#F8F8F6]">Team Performance Analytics</h2>
            <p id="txt-analytics-subtitle" className="mt-1 text-sm text-[#C8A54B]">Scope: QA BRIAN (BF)</p>
          </div>
