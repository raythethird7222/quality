    ...
    <div className="min-h-screen bg-[#020d1b] text-[#F8F8F6]">
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="border-b border-[#1a2f4e] px-6 py-6 md:px-10">
          <Link
            href="/bf"
            className="mb-6 inline-flex items-center gap-2 rounded-lg border border-[#243d5b] bg-[#071827] px-4 py-2 text-sm font-medium text-[#C8A54B] transition hover:border-[#C8A54B] hover:bg-[#0a2540]"
          >
            <ArrowLeft size={18} />
            Return back
          </Link>
          ...
          <div className="flex items-center gap-2 text-sm text-[#dfe8f3]/75">
            <Link href="/" className="hover:text-[#C8A54B] transition">
              Home
            </Link>
            <span>/</span>
            <Link href="/bf" className="hover:text-[#C8A54B] transition">
              BF
            </Link>
            <span>/</span>
            <span className="text-[#C8A54B]">Dashboard</span>
          </div>
        </div>
            ...
            <section id="view-account-dashboard" className="rounded-[16px] border border-[#243d5b] bg-[#071827]/60 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
              ...
              <div className="relative flex flex-wrap items-center justify-space-between gap-4">
                <div className="text-center">
                  <h2 id="txt-active-account-title" className="text-xl font-bold text-[#F8F8F6]">
                    Account Framework View • BF • QA BRIAN
                  </h2>
                </div>

                <div className="absolute right-0 flex flex-wrap items-center gap-3">
                  <Link href="/bf/analytics" className="flex items-center gap-2 rounded-[10px] border border-[#C8A54B] bg-[#C8A54B] px-4 py-2 font-medium text-[#020d1b] transition hover:bg-[#b8942f]">
                    <LineChart size={16} />
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-[10px] border border-[#243d5b] bg-transparent px-4 py-2 font-medium text-[#C8A54B] transition hover:bg-[#C8A54B]/10"
              ...
              >
                <div className="flex items-center gap-4">
                  <button
                    className="flex items-center gap-2 rounded-lg border border-[#232d3f] bg-[#1f293d] px-4 py-2 text-sm font-medium text-white transition hover:border-[#C8A54B]"
                  ...
                  <div className="relative inline-block">
                    ...
                    >
                      Aug 15, 2026
                      <CalendarDays size={12} className="text-[#C8A54B]" />
                    </span>
              ...
              >
                <div className="bg-[#121824] p-5 text-left">
                  ...
                  <span className="block mt-[5px] text-[32px] font-bold text-[#C8A54B]">
                    1,284
                  </span>
                </div>
                <div className="bg-[#121824] p-5 text-left">
              ...
              <div className="my-6 rounded-lg border border-[#232d3f] bg-[rgba(18,24,36,0.6)] p-5">
                <h3 className="mb-4 block text-base tracking-[0.5px] text-[#8fa0dd]">
                  <List size={16} className="mr-2 inline-block text-[#C8A54B]" /> Individual Agent Performance Breakdown
                </h3>
                  ...
                  <tbody className="opacity-100">
                    {performanceData.map((row, idx) => (
                      <tr key={idx} className="border-b border-[#232d3f]">
                        ...
                        <td className="p-[10px] text-[14px] text-[#C8A54B]">{row.avgScore}</td>
              ...
              <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div>
                  <h3 className="mb-[6px] block text-lg leading-[1.4] relative">
                    <Users size={18} className="mr-2 inline-block text-[#C8A54B]" /> Managed Coach Roster Scope
                  </h3>
                  ...
                  <div className="space-y-2">
                    {agents.map((agent, idx) => (
                      <div key={idx} className="flex items-center justify-between rounded-lg border border-[#232d3f] bg-[#0a2540] p-3 transition hover:border-[#C8A54B]">
                        <div className="flex items-center gap-3" style={{ width: "100%" }}>
                          <span className="font-medium text-[#F8F8F6]">{agent.name}</span>
                          <span
                            className="inline-block border bg-[rgba(200,165,75,0.12)] px-[6px] py-[2px] text-[11px] font-medium leading-none tracking-[0.3px] text-[#C8A54B] rounded-[4px]"
                ...
                <div>
                  <h3 className="mb-[6px] block text-lg leading-[1.4] relative">
                    <Users size={18} className="mr-2 inline-block text-[#C8A54B]" /> Evaluator Operational Allocations
                  </h3>
                  <p className="mb-[15px] block leading-[1.4] relative">
