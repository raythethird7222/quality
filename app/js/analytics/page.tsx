    ...
    <div className="min-h-screen bg-[#020d1b] text-[#F8F8F6]">
      <div className="mx-auto max-w-[1400px]">
        <section id="view-analytics-dashboard" className="p-6 md:p-10">
          <div className="mb-6">
            <Link href="/js/dashboard" className="mb-4 inline-flex items-center gap-2 rounded-lg border border-[#243d5b] bg-[#071827] px-4 py-2 text-sm font-medium text-[#7dd3fc] transition hover:border-[#7dd3fc] hover:bg-[#0a2540]">
              <ArrowLeft size={18} />
              Return back
            </Link>
            <h2 id="txt-analytics-title" className="text-xl font-bold text-[#F8F8F6]">Team Performance Analytics</h2>
            <p id="txt-analytics-subtitle" className="mt-1 text-sm text-[#00f0ff]">Scope: QA CHERYL (JS)</p>
          </div>
          ...
          <div className="analytics-filter-toolbar mb-6 flex flex-wrap items-center gap-4">
              ...
              <div className="analytics-filter-group flex items-center gap-2">
                ...
                <div className="timeframe-toggle-buttons flex items-center gap-1">
                  <button id="btn-tf-daily" className="btn btn-secondary btn-sm active border border-[#243d5b] bg-[#00f0ff]/10 px-3 py-2 text-xs font-medium text-[#00f0ff]">Daily</button>
                  <button id="btn-tf-weekly" className="btn btn-secondary btn-sm border border-[#243d5b] bg-[#071827] px-3 py-2 text-xs font-medium text-[#7dd3fc]">Weekly</button>
                  <button id="btn-tf-monthly" className="btn btn-secondary btn-sm border border-[#243d5b] bg-[#071827] px-3 py-2 text-xs font-medium text-[#7dd3fc]">Monthly</button>
                  <button id="btn-tf-quarterly" className="btn btn-secondary btn-sm border border-[#243d5b] bg-[#071827] px-3 py-2 text-xs font-medium text-[#7dd3fc]">Quarterly</button>
                  <button id="btn-tf-yearly" className="btn btn-secondary btn-sm border border-[#243d5b] bg-[#071827] px-3 py-2 text-xs font-medium text-[#7dd3fc]">Yearly</button>
                </div>
              </div>
              <div className="analytics-filter-group flex items-center gap-2">
