  ...
  return (
    <div className="min-h-screen bg-[#020d1b] text-[#F8F8F6]">
      <div className="mx-auto max-w-[1400px]">
        {/* Navigation section */}
        <div className="flex px-6 py-6 gap-8 md:px-10">
          <Link
            href="/js"
            className="inline-flex items-center gap-2 rounded-lg border border-[#243d5b] bg-[#071827] px-4 py-2 text-sm font-medium text-[#7dd3fc] transition hover:border-[#7dd3fc] hover:bg-[#0a2540]"
          >
            <ArrowLeft size={18} />
            Return back
          </Link>
          ...
          <div className="flex items-center gap-2 text-sm text-[#dfe8f3]/75">
            ...
            <span>/</span>
            <Link href="/js" className="hover:text-[#7dd3fc] transition">
              JS
            </Link>
            <span>/</span>
              ...
              <div className="relative flex flex-wrap items-center justify-space-between gap-4">
                <div className="text-center">
                  <h2 id="txt-active-account-title" className="text-xl font-bold text-[#F8F8F6]">
                    Account Framework View • JS • QA CHERYL
                  </h2>
                </div>

                <div className="absolute right-0 flex flex-wrap items-center gap-3">
                  <Link href="/js/analytics" className="flex items-center gap-2 rounded-[10px] border border-[#7dd3fc] bg-[#7dd3fc] px-4 py-2 font-medium text-[#020d1b] transition hover:bg-[#5bc0eb]">
                  <LineChart size={16} />
