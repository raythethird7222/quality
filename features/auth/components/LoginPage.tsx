      ...
      <div className="relative z-10 w-full max-w-[900px] bg-card rounded-2xl shadow-[0_25px_70px_rgba(0,0,0,0.15)] overflow-hidden border border-border flex flex-col md:flex-row min-h-[560px]">
        ...
        <section className="md:w-[58%] px-8 sm:px-14 py-8 flex flex-col justify-center">
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-11 pr-4 rounded-lg border border-border bg-card text-foreground text-sm outline-none transition-all placeholder:text-muted-foreground focus:border-brand-indigo focus:ring-3 focus:ring-brand-indigo/10"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-11 pr-11 rounded-lg border border-border bg-card text-foreground text-sm outline-none transition-all placeholder:text-muted-foreground focus:border-brand-indigo focus:ring-3 focus:ring-brand-indigo/10"
                />
            ...
            <button
              type="submit"
              className="w-full h-11 rounded-lg bg-brand-indigo text-white font-semibold tracking-wide shadow-md hover:bg-brand-indigo/90 hover:shadow-lg transition-all flex items-center justify-center gap-3"
            >
              LOG IN
