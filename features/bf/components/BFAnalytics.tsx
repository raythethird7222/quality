...
export default function BFAnalytics() {
  const d = linePoints;
    ...
    <div className="min-h-screen bg-surface-base text-text-primary">
      <div className="mx-auto max-w-[1440px]">
        <section id="view-analytics-dashboard" className="p-6 md:p-10">
          <div className="mb-6">
            <Link href="/bf/dashboard" className="mb-4 inline-flex items-center gap-2 rounded-lg border border-border-default bg-surface-overlay px-4 py-2 text-sm font-medium text-brand-gold transition hover:border-brand-gold hover:bg-surface-elevated">
              <ArrowLeft size={18} />
              Return back
            </Link>
            <h2 id="txt-analytics-title" className="text-xl font-bold text-text-primary">Team Performance Analytics</h2>
            <p id="txt-analytics-subtitle" className="mt-1 text-sm text-brand-gold">Scope: QA BRIAN (BF)</p>
          </div>
