...
const a = { text: "text-brand-charcoal", bg: "bg-brand-charcoal", border: "border-brand-charcoal", bgLight: "bg-brand-charcoal/10", hex: "#363435" };
    ...
    <div className="min-h-screen bg-surface-base text-text-primary">
      <div className="mx-auto max-w-[1440px] px-6 py-5 md:px-9">
        <nav className="mb-6 flex flex-wrap items-center gap-3 text-[13px]" aria-label="Breadcrumb">
          ...
          <span className="font-medium text-text-primary">Manager Analytics</span>
        </nav>

        <div className="mb-8">
          <h1 className="text-2xl font-bold tracking-tight text-text-primary">Manager Performance Analytics</h1>
