...
export default function NotificationPanel({ open, onClose, employeeId, onUnreadCountChange }: { open: boolean; onClose: () => void; employeeId: number; onUnreadCountChange: (count: number) => void }) {
  ...
  if (!open) return null;
  return createPortal(<div className="fixed right-4 top-16 z-[9999] max-h-[460px] w-[min(380px,calc(100vw-2rem))] overflow-hidden rounded-xl border border-border-default bg-card shadow-xl">
